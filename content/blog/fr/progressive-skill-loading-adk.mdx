...
![Agent ADK câblé aux quatre patterns de skill : inline, file-based, external et meta skill, tous exposés via un seul SkillToolset](/blog/adk-skill-patterns.png)
